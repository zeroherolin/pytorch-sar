...
$$S_{\text{2df,stolt}}(f_\tau', f_\eta) = \text{Interp}fτ \left( S_{\text{2df,matched}}(f_\tau, f_\eta) \to f_\tau' \right)$$
...
$$H_{CS}(\tau', f_\eta) = \exp \left( \pi K_m \left[ \frac {D(f_{\eta_{\text{ref}}}, V_{r_{\text{ref}}})} {D(f_\eta, V_{r_{\text{ref}}})} - 1 \right] (\tau')^2 \right)$$
...
$$S_{\text{2df,scaled}}(f_\tau, f_\eta) = \text{FFT}\tau\left(S_{\eta f,\text{scaled}}(\tau, f_\eta)\right)$$
...
$$S_{\eta f,\text{comp}}(\tau, f_\eta) = \text{IFFT}\tau\left(S_{\text{2df,comp}}(f_\tau, f_\eta)\right)$$
...
$$S_{\text{image}}(\tau, \eta) = \text{IFFT}\eta\left(S_{\eta f,\text{ac}}(\tau, f_\eta)\right)$$
